...
import com.handstandsam.wiremock.android.WireMockAndroidApplication;
...
public class WireMockApplicationTestCase extends ApplicationTestCase<WireMockAndroidApplication> {

    Logger logger = LoggerFactory.getLogger(WireMockApplicationTestCase.class);

    public WireMockApplicationTestCase() {
        super(WireMockAndroidApplication.class);
    }
